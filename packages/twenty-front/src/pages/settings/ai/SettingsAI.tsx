...
import { SettingsAIBrainTab } from '~/pages/settings/ai/components/SettingsAIBrainTab';
import { SettingsAIMoreTab } from '~/pages/settings/ai/components/SettingsAIMoreTab';
import { SettingsAIPermissionsTab } from '~/pages/settings/ai/components/SettingsAIPermissionsTab';
...
export const SettingsAI = () => {
  ...
  const tabs = [
    ...
    {
      id: SETTINGS_AI_TABS.TABS_IDS.BRAIN,
      title: t`Brain`,
      Icon: IconCpu,
    },
    {
      id: SETTINGS_AI_TABS.TABS_IDS.PERMISSIONS,
      title: t`Permissions`,
      Icon: IconLock,
    },
  ];
  ...
  const isBrainTab = activeTabId === SETTINGS_AI_TABS.TABS_IDS.BRAIN;
  const isPermissionsTab = activeTabId === SETTINGS_AI_TABS.TABS_IDS.PERMISSIONS;
  ...
  return (
    ...
    >
      <SettingsPageContainer>
        ...
        {isBrainTab && <SettingsAIBrainTab />}
        {isPermissionsTab && <SettingsAIPermissionsTab />}
      </SettingsPageContainer>
    </SubMenuTopBarContainer>
  );
};
